...
function showCart() {
  ...
  for (let i = 0; i < cart.length; i++) {
    ...
    button.style.background = "rgb(226, 148, 15)";
    ...
    increButton.style.border = "1px solid white";
    increButton.style.color = "white";
    increButton.style.background = "rgb(226, 148, 15)";
    increButton.style.width = "30px";
    increButton.style.height = "30px";
    increButton.style.marginLeft = "50px";
    ...
    decreButton.style.border = "1px solid white";
    decreButton.style.color = "white";
    decreButton.style.background = "rgb(226, 148, 15)";
    ...
    likeButton.style.border = "1px solid white";
    likeButton.style.color = "white";
    likeButton.style.background = "rgb(226, 148, 15)";
